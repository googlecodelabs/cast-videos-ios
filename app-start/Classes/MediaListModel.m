...
- (void)decodeItemListFromArray:(NSArray *)array
  ...
  for (NSDictionary *element in array) {
    ...
    NSArray *tracks = [dict objectForKey:kKeyTracks];
    for (id trackElement in tracks) {
      ...
      /*
          ...
          NSInteger identifier = [trackDict objectForKey:kKeyID];
          NSString *name = [trackDict objectForKey:kKeyName];
          NSString *typeString = [trackDict objectForKey:kKeyType];
          NSString *subtypeString = [trackDict objectForKey:kKeySubtype];
          NSString *contentID = [trackDict objectForKey:kKeyContentID];
          NSString *language = [trackDict objectForKey:kKeyLanguage];

          NSURL *url = [self buildURLWithString:contentID
